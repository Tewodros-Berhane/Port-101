...
class HrLeaveTypeStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['required', 'string', 'max:120', Rule::unique('hr_leave_types', 'name')->where('company_id', $companyId)],
            'code' => ['nullable', 'string', 'max:32', Rule::unique('hr_leave_types', 'code')->where('company_id', $companyId)],
