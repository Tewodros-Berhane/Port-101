    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            $components = collect($this->input('bundle.components', []))
                ...
                ->values();
            $currentProductId = (string) ($this->route('product')?->id ?? '');
            ...
            if ($currentProductId !== '' && $componentIds->contains($currentProductId)) {
                $validator->errors()->add('bundle.components', 'A bundle cannot include itself as a component.');
            }
            ...
            foreach ($componentIds as $componentId) {
                ...
                if ($componentProduct->id !== $currentProductId && $componentProduct->hasActiveBundle()) {
