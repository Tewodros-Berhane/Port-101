...
export default function InventoryReorderingEdit({ rule, products, locations, vendors }: Props) {
    const form = useForm({
        ...rule,
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit', href: `/company/inventory/reordering/${rule.id}/edit` },
            ]}
        >
            <Head title="Edit Reordering Rule" />

            <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h1 className="text-xl font-semibold">Edit reordering rule</h1>
                    <p className="text-sm text-muted-foreground">
                        Adjust thresholds, preferred vendor, and lead time for this replenishment policy.
                    </p>
                </div>
            ...
            <form
                ...
                onSubmit={(event) => {
                    ...
                    form.put(`/company/inventory/reordering/${rule.id}`);
                }}
            >
